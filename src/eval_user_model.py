#!/usr/bin/env python2
"""Evaluate wrapper for user model."""
...
from .model.user_model_helper import eval_model
...
def main():
    ...
    cmdline_parser.add_argument('--is_infer',
                                type=int,
                                default=0,
                                help='If infer, outputs embeddings.')
    ...
    eval_model(
        ...
        eval_output_basename=args.outbase, is_infer=bool(args.is_infer)
    )
